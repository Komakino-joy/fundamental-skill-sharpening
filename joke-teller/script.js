...
function tellMe(joke) {
    VoiceRSS.speech({
        key: '53b64e8739c34679889c4cab98d9b4e5',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJokes() {
    let joke = '';
    const url = 'https://v2.jokeapi.dev/joke/Programming,Pun,Spooky?blacklistFlags=nsfw,religious,political,racist,sexist,explicit';
    try {
